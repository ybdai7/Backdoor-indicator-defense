...
class GeneralBenignClient(AbstractClient):
    def __init__(self, params):
        super(GeneralBenignClient, self).__init__(params)
    ...
    def local_training(self, train_data, target_params_variables, test_data=None, poisoned_pattern_choose=None):
        total_loss = 0
