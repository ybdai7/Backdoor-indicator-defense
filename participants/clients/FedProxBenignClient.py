...
class FedProxBenignClient(AbstractClient):
    ...
    def local_training(self, train_data, target_params_variables, global_data, is_log_train, test_data=None, poisoned_pattern_choose=None, round=None, model_id=None):
        total_loss = 0
